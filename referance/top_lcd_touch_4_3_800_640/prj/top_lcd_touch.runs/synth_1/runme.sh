...
HD_PWD='E:/Xilinx/FPGA_Prjs/dzy/referance/top_lcd_touch_4_3_800_640/prj/top_lcd_touch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lcd_touch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_lcd_touch.tcl
