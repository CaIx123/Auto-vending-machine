...
HD_PWD='E:/Xilinx/FPGA_Prjs/dzy/referance/top_lcd_touch_4_3_800_640/prj/top_lcd_touch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lcd_touch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_lcd_touch.tcl -notrace
