...
#
# Script generated by Vivado on Thu Dec 07 23:12:48 +0800 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Xilinx/FPGA_Prjs/dzy/referance/22_lcd_rgb_char/prj/lcd_rgb_char.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
