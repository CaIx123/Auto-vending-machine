...
HD_PWD='E:/Xilinx/FPGA_Prjs/dzy/Automatic vending machine/prj/Auto_Vending_Machine/Auto_Vending_Machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lcd_touch_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_lcd_touch_FSM.tcl
