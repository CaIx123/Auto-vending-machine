...
HD_PWD='E:/Xilinx/FPGA_Prjs/dzy/Automatic vending machine/prj/Auto_Vending_Machine/Auto_Vending_Machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lcd_touch_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_lcd_touch_FSM.tcl -notrace
